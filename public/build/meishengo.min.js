...
};_.mixin=function(obj){each(_.functions(obj),function(name){addToWrapper(name,_[name]=obj[name])})};var idCounter=0;_.uniqueId=function(prefix){var id=idCounter++;return prefix?prefix+id:id};_.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var noMatch=/.^/;var escapes={"\\":"\\","'":"'",r:"\r",n:"\n",t:"	",u2028:"\u2028",u2029:"\u2029"};for(var key in escapes)escapes[escapes[key]]=key;var escaper=/\\|'|\r|\n|\t|\u2028|\u2029/g;var unescaper=/\\(\\|'|r|n|t|u2028|u2029)/g;var unescape=function(code){return code.replace(unescaper,function(match,escape){return escapes[escape]})};_.template=function(text,data,settings){settings=_.defaults(settings||{},_.templateSettings);var source="__p+='"+text.replace(escaper,function(match){return"\\"+escapes[match]}).replace(settings.escape||noMatch,function(match,code){return"'+\n((__t=("+unescape(code)+"))==null?'':_.escape(__t))+\n'"}).replace(settings.interpolate||noMatch,function(match,code){return"'+\n((__t=("+unescape(code)+"))==null?'':__t)+\n'"}).replace(settings.evaluate||noMatch,function(match,code){return"';\n"+unescape(code)+"\n__p+='"})+"';\n";if(!settings.variable)source="with(obj||{}){\n"+source+"}\n";source="var __t,__p='',__j=Array.prototype.join,"+"print=function(){__p+=__j.call(arguments,'')};\n"+source+"return __p;\n";var render=new Function(settings.variable||"obj","_",source);if(data)return render(data,_);var template=function(data){return render.call(this,data,_)};template.source="function("+(settings.variable||"obj")+"){\n"+source+"}";return template};_.chain=function(obj){return _(obj).chain()};var wrapper=function(obj){this._wrapped=obj};_.prototype=wrapper.prototype;var result=function(obj,chain){return chain?_(obj).chain():obj};var addToWrapper=function(name,func){wrapper.prototype[name]=function(){var args=slice.call(arguments);unshift.call(args,this._wrapped);return result(func.apply(_,args),this._chain)}};_.mixin(_);each(["pop","push","reverse","shift","sort","splice","unshift"],function(name){var method=ArrayProto[name];wrapper.prototype[name]=function(){var obj=this._wrapped;method.apply(obj,arguments);if((name=="shift"||name=="splice")&&obj.length===0)delete obj[0];return result(obj,this._chain)}});each(["concat","join","slice"],function(name){var method=ArrayProto[name];wrapper.prototype[name]=function(){return result(method.apply(this._wrapped,arguments),this._chain)}});wrapper.prototype.chain=function(){this._chain=true;return this};wrapper.prototype.value=function(){return this._wrapped}}.call(this)});require.register("visionmedia-page.js/index.js",function(exports,require,module){!function(){var dispatch=true;var base="";var running;function page(path,fn){if("function"==typeof path){return page("*",path)}if("function"==typeof fn){var route=new Route(path);for(var i=1;i<arguments.length;++i){page.callbacks.push(route.middleware(arguments[i]))}}else if("string"==typeof path){page.show(path,fn)}else{page.start(path)}}page.callbacks=[];page.base=function(path){if(0==arguments.length)return base;base=path};page.start=function(options){options=options||{};if(running)return;running=true;if(false===options.dispatch)dispatch=false;if(false!==options.popstate)window.addEventListener("popstate",onpopstate,false);if(false!==options.click)window.addEventListener("click",onclick,false);if(!dispatch)return;page.replace(location.pathname+location.search,null,true,dispatch)};page.stop=function(){running=false;removeEventListener("click",onclick,false);removeEventListener("popstate",onpopstate,false)};page.show=function(path,state,dispatch){var ctx=new Context(path,state);if(false!==dispatch)page.dispatch(ctx);if(!ctx.unhandled)ctx.pushState();return ctx};page.replace=function(path,state,init,dispatch){var ctx=new Context(path,state);ctx.init=init;if(null==dispatch)dispatch=true;if(dispatch)page.dispatch(ctx);ctx.save();return ctx};page.dispatch=function(ctx){var i=0;function next(){var fn=page.callbacks[i++];if(!fn)return unhandled(ctx);fn(ctx,next)}next()};function unhandled(ctx){if(window.location.pathname+window.location.search==ctx.canonicalPath)return;page.stop();ctx.unhandled=true;window.location=ctx.canonicalPath}function Context(path,state){if("/"==path[0]&&0!=path.indexOf(base))path=base+path;var i=path.indexOf("?");this.canonicalPath=path;this.path=path.replace(base,"")||"/";this.title=document.title;this.state=state||{};this.state.path=path;this.querystring=~i?path.slice(i+1):"";this.pathname=~i?path.slice(0,i):path;this.params=[]}page.Context=Context;Context.prototype.pushState=function(){history.pushState(this.state,this.title,this.canonicalPath)};Context.prototype.save=function(){history.replaceState(this.state,this.title,this.canonicalPath)};function Route(path,options){options=options||{};this.path=path;this.method="GET";this.regexp=pathtoRegexp(path,this.keys=[],options.sensitive,options.strict)}page.Route=Route;Route.prototype.middleware=function(fn){var self=this;return function(ctx,next){if(self.match(ctx.path,ctx.params))return fn(ctx,next);next()}};Route.prototype.match=function(path,params){var keys=this.keys,qsIndex=path.indexOf("?"),pathname=~qsIndex?path.slice(0,qsIndex):path,m=this.regexp.exec(pathname);if(!m)return false;for(var i=1,len=m.length;i<len;++i){var key=keys[i-1];var val="string"==typeof m[i]?decodeURIComponent(m[i]):m[i];if(key){params[key.name]=undefined!==params[key.name]?params[key.name]:val}else{params.push(val)}}return true};function pathtoRegexp(path,keys,sensitive,strict){if(path instanceof RegExp)return path;if(path instanceof Array)path="("+path.join("|")+")";path=path.concat(strict?"":"/?").replace(/\/\(/g,"(?:/").replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?/g,function(_,slash,format,key,capture,optional){keys.push({name:key,optional:!!optional});slash=slash||"";return""+(optional?"":slash)+"(?:"+(optional?slash:"")+(format||"")+(capture||format&&"([^/.]+?)"||"([^/]+?)")+")"+(optional||"")}).replace(/([\/.])/g,"\\$1").replace(/\*/g,"(.*)");return new RegExp("^"+path+"$",sensitive?"":"i")}function onpopstate(e){if(e.state){var path=e.state.path;page.replace(path,e.state)}}function onclick(e){if(1!=which(e))return;if(e.metaKey||e.ctrlKey||e.shiftKey)return;if(e.defaultPrevented)return;var el=e.target;while(el&&"A"!=el.nodeName)el=el.parentNode;if(!el||"A"!=el.nodeName)return;var href=el.href;var path=el.pathname+el.search;if(el.hash||"#"==el.getAttribute("href"))return;if(el.target)return;if(!sameOrigin(href))return;var orig=path;path=path.replace(base,"");if(base&&orig==path)return;e.preventDefault();page.show(orig)}function which(e){e=e||window.event;return null==e.which?e.button:e.which}function sameOrigin(href){var origin=location.protocol+"//"+location.hostname;if(location.port)origin+=":"+location.port;return 0==href.indexOf(origin)}if("undefined"==typeof module){window.page=page}else{module.exports=page}}()});require.register("dawicorti-Sonic/src/sonic.js",function(exports,require,module){module.exports=function(){var emptyFn=function(){};function Sonic(d){this.converter=d.converter;this.data=d.path||d.data;this.imageData=[];this.multiplier=d.multiplier||1;this.padding=d.padding||0;this.fps=d.fps||25;this.stepsPerFrame=~~d.stepsPerFrame||1;this.trailLength=d.trailLength||1;this.pointDistance=d.pointDistance||.05;this.domClass=d.domClass||"sonic";this.backgroundColor=d.backgroundColor||"rgba(0,0,0,0)";this.fillColor=d.fillColor;this.strokeColor=d.strokeColor;this.stepMethod=typeof d.step=="string"?stepMethods[d.step]:d.step||stepMethods.square;this._setup=d.setup||emptyFn;this._teardown=d.teardown||emptyFn;this._preStep=d.preStep||emptyFn;this.width=d.width;this.height=d.height;this.fullWidth=this.width+2*this.padding;this.fullHeight=this.height+2*this.padding;this.domClass=d.domClass||"sonic";this.setup()}var argTypes=Sonic.argTypes={DIM:1,DEGREE:2,RADIUS:3,OTHER:0};var argSignatures=Sonic.argSignatures={arc:[1,1,3,2,2,0],bezier:[1,1,1,1,1,1,1,1],line:[1,1,1,1]};var pathMethods=Sonic.pathMethods={bezier:function(t,p0x,p0y,p1x,p1y,c0x,c0y,c1x,c1y){t=1-t;var i=1-t,x=t*t,y=i*i,a=x*t,b=3*x*i,c=3*t*y,d=y*i;return[a*p0x+b*c0x+c*c1x+d*p1x,a*p0y+b*c0y+c*c1y+d*p1y]},arc:function(t,cx,cy,radius,start,end){var point=(end-start)*t+start;var ret=[Math.cos(point)*radius+cx,Math.sin(point)*radius+cy];ret.angle=point;ret.t=t;return ret},line:function(t,sx,sy,ex,ey){return[(ex-sx)*t+sx,(ey-sy)*t+sy]}};var stepMethods=Sonic.stepMethods={square:function(point,i,f,color,alpha){this._.fillRect(point.x-3,point.y-3,6,6)},fader:function(point,i,f,color,alpha){this._.beginPath();if(this._last){this._.moveTo(this._last.x,this._last.y)}this._.lineTo(point.x,point.y);this._.closePath();this._.stroke();this._last=point}};Sonic.prototype={setup:function(){var args,type,method,value,data=this.data;this.canvas=document.createElement("canvas");this._=this.canvas.getContext("2d");this.canvas.className=this.domClass;this.canvas.height=this.fullHeight;this.canvas.width=this.fullWidth;this.points=[];for(var i=-1,l=data.length;++i<l;){args=data[i].slice(1);method=data[i][0];if(method in argSignatures)for(var a=-1,al=args.length;++a<al;){type=argSignatures[method][a];value=args[a];switch(type){case argTypes.RADIUS:value*=this.multiplier;break;case argTypes.DIM:value*=this.multiplier;value+=this.padding;break;case argTypes.DEGREE:value*=Math.PI/180;break}args[a]=value}args.unshift(0);for(var r,pd=this.pointDistance,t=pd;t<=1;t+=pd){t=Math.round(t*1/pd)/(1/pd);args[0]=t;r=pathMethods[method].apply(null,args);this.points.push({x:r[0],y:r[1],progress:t})}}this.frame=0;if(this.converter&&this.converter.setup){this.converter.setup(this)}},prep:function(frame){if(frame in this.imageData){return}this._.clearRect(0,0,this.fullWidth,this.fullHeight);this._.fillStyle=this.backgroundColor;this._.fillRect(0,0,this.fullWidth,this.fullHeight);var points=this.points,pointsLength=points.length,pd=this.pointDistance,point,index,frameD;this._setup();for(var i=-1,l=pointsLength*this.trailLength;++i<l&&!this.stopped;){index=frame+i;point=points[index]||points[index-pointsLength];if(!point)continue;this.alpha=Math.round(1e3*(i/(l-1)))/1e3;this._.globalAlpha=this.alpha;if(this.fillColor){this._.fillStyle=this.fillColor}if(this.strokeColor){this._.strokeStyle=this.strokeColor}frameD=frame/(this.points.length-1);indexD=i/(l-1);this._preStep(point,indexD,frameD);this.stepMethod(point,indexD,frameD)}this._teardown();this.imageData[frame]=this._.getImageData(0,0,this.fullWidth,this.fullWidth);return true},draw:function(){if(!this.prep(this.frame)){this._.clearRect(0,0,this.fullWidth,this.fullWidth);this._.putImageData(this.imageData[this.frame],0,0)}if(this.converter&&this.converter.step){this.converter.step(this)}if(!this.iterateFrame()){if(this.converter&&this.converter.teardown){this.converter.teardown(this);this.converter=null}}},iterateFrame:function(){this.frame+=this.stepsPerFrame;if(this.frame>=this.points.length){this.frame=0;return false}return true},play:function(){this.stopped=false;var hoc=this;this.timer=setInterval(function(){hoc.draw()},1e3/this.fps)},stop:function(){this.stopped=true;this.timer&&clearInterval(this.timer)}};return Sonic}()});require.register("proxy-client/index.js",function(exports,require,module){"use strict";var instances={};exports.createInstance=function(name){instances[name]=window.io.connect();return instances[name]};exports.getInstance=function(name){return instances[name]}});require.register("loader/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),Sonic=require("Sonic");exports.start=function(){exports.stop();var height=parseInt($("header").height()*.3,10),width=3*height,square=new Sonic({width:width,height:height,fillColor:"#d6a692",path:[["line",0,0,width,0],["line",width,0,width,height],["line",width,height,0,height],["line",0,height,0,0]]});square.play();$("header").append(square.canvas)};exports.stop=function(){$("header .sonic").remove()}});require.register("login-form/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),template=require("./template"),page=require("page"),proxyClient=require("proxy-client"),loader=require("loader");function LoginForm(){_.bindAll(this)}LoginForm.prototype.render=function(){this.$el=$(template);this.$el.submit(this.onConnect);return this};LoginForm.prototype.onConnect=function(event){event.preventDefault();this.$el.animate({opacity:0},{duration:800});loader.start();this.login=$(".login",this.$el).val();this.password=$(".password",this.$el).val();this.proxyClient=proxyClient.createInstance("pandanet");this.proxyClient.once("auth:request",this.onAuthRequest)};LoginForm.prototype.onAuthRequest=function(){this.proxyClient.emit("auth:sending",{login:this.login,password:this.password});this.proxyClient.once("auth:success",this.openHomePage)};LoginForm.prototype.openHomePage=function(){page("#!/home")};module.exports=LoginForm});require.register("login-form/template.js",function(exports,require,module){module.exports='<form class="login-form">\n    <input type="text" class="login" placeholder="IGS login" />\n    <input type="password" class="password" placeholder="IGS password" />\n    <input type="submit" class="connect" value="connect" />\n</form>'});require.register("login-page/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),LoginForm=require("login-form"),footerTemplate=require("./footer-template"),contentTemplate=require("./content-template");function LoginPage(){_.bindAll(this)}LoginPage.prototype.open=function(){$("#content").html(contentTemplate);$("footer").html(footerTemplate);$("header").html((new LoginForm).render().$el)};module.exports=LoginPage});require.register("login-page/footer-template.js",function(exports,require,module){module.exports='<span class="no-account">You don\'t have an IGS account ? <a href="http://pandanet-igs.com/igs_users/register" target="blank">Create one</a></span>'});require.register("login-page/content-template.js",function(exports,require,module){module.exports='<div class="title">\n    <h1>meishengo</h1>\n</div>\n<div class="goban-bg"></div>'});require.register("top-menu/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),template=require("./template"),page=require("page");function TopMenu(currentPage,animated){_.bindAll(this);this.currentPage=currentPage||null;this.animationDuration=!animated?0:500}TopMenu.prototype.enlightCurrent=function(){if($.contains(window.document.documentElement,this.$el[0])){$(this.$pages[this.enlightIndex]).animate({opacity:1},{duration:this.animationDuration,done:this.onEnlightDone})}else{_.delay(this.enlightCurrent,100)}};TopMenu.prototype.onEnlightDone=function(){this.enlightIndex-=1;if(this.enlightIndex>=0){this.enlightCurrent()}};TopMenu.prototype.wrapLinks=function(){_.each($("a",this.$el),function(link){var $link=$(link);$link.click(function(event){event.stopPropagation();page($link.attr("href"))})})};TopMenu.prototype.render=function(){this.$el=$(template);this.wrapLinks();if(this.currentPage!==null){$("."+this.currentPage,this.$el).addClass("current")}this.$pages=$(".page",this.$el);this.enlightIndex=this.$pages.length-1;this.enlightCurrent();return this};module.exports=TopMenu});require.register("top-menu/template.js",function(exports,require,module){module.exports='<div class="top-menu">\n    <a class="page profile" href="#!/profile">profile</a>\n    <a class="page players" href="#!/players">players</a>\n    <a class="page games" href="#!/games">games</a>\n</div>'});require.register("home-page/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),TopMenu=require("top-menu");function HomePage(){_.bindAll(this)}HomePage.prototype.open=function(){$("header").html(new TopMenu(null,true).render().$el);$("footer").empty()};module.exports=HomePage});require.register("player-tag/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),template=require("./template"),local={};local.callback=function(){};function PlayerTag(player){_.bindAll(this);this.player=player}PlayerTag.prototype.render=function(){this.$el=$(template);$(".name",this.$el).html(this.player.login);$(".rank",this.$el).html(this.player.rank);this.$el.click(this.onClick);return this};PlayerTag.prototype.onClick=function(){local.callback(this.player)};PlayerTag.onSelectPlayer=function(callback){local.callback=callback};module.exports=PlayerTag});require.register("player-tag/template.js",function(exports,require,module){module.exports='<div class="player-tag">\n    <span class="name"></span>\n    <div class="rank"></div>\n</div>'});require.register("players-list/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),template=require("./template"),proxyClient=require("proxy-client"),PlayerTag=require("player-tag"),loader=require("loader");function PlayersList(options){_.bindAll(this);this.proxyClient=proxyClient.getInstance("pandanet");this.onVisible=options.visible;this.areaNames=[".players-area-top",".players-area-right",".players-area-bottom"]}PlayersList.prototype.render=function(){this.$el=$(template);loader.start();this.proxyClient.emit("players:list:request");this.proxyClient.once("players:list:success",this.onPlayersListSuccess);return this};PlayersList.prototype.enlightColumn=function(){var index=0,columnIndex=_.keys(this.columns)[this.columnSlot],column=this.columns[columnIndex];for(index=0;index<column.length;index+=1){column[index].$el.animate({opacity:1},{duration:600})}_.delay(this.nextColumn,20)};PlayersList.prototype.nextColumn=function(){this.columnSlot+=1;if(this.columnSlot<_.size(this.columns)){this.enlightColumn()}};PlayersList.prototype.addPlayerTag=function(player,index){var playerTag=new PlayerTag(player),columnIndex;if(this.areaIndex<this.areaNames.length){this.$area.append(playerTag.render().$el);if(playerTag.$el.position().top+playerTag.$el.height()>this.$area.height()){playerTag.$el.remove();this.areaIndex+=1;if(this.areaIndex<this.areaNames.length){this.$area=$(this.areaNames[this.areaIndex],this.$el)}else if(!this.playersCountByPage){this.playersCountByPage=index}}else{columnIndex="col"+$(".name",playerTag.$el).offset().left;if(!_.has(this.columns,columnIndex)){this.columns[columnIndex]=[]}this.columns[columnIndex].push(playerTag)}}};PlayersList.prototype.onPlayersListSuccess=function(data){loader.stop();this.fetchedPlayersList=data.players;this.rawPlayersList=_.clone(this.fetchedPlayersList);this.openPage(0);this.onVisible()};PlayersList.prototype.addPlayers=function(){$(".players-area",this.$el).empty();_.each(this.players,this.addPlayerTag,this);this.enlightColumn()};PlayersList.prototype.openPage=function(pageIndex){var status=false;if(!this.playersCountByPage||pageIndex>=0&&pageIndex*this.playersCountByPage<this.rawPlayersList.length){this.areaIndex=0;this.$area=$(this.areaNames[this.areaIndex],this.$el);this.columns={};this.columnSlot=0;if(!this.playersCountByPage){this.players=this.rawPlayersList}else{this.players=this.rawPlayersList.slice(pageIndex*this.playersCountByPage,(pageIndex+1)*this.playersCountByPage-1)}this.addPlayers();status=true}return status};PlayersList.prototype.search=function(text){this.rawPlayersList=_.filter(this.fetchedPlayersList,function(player){return player.login.toLowerCase().indexOf(text)!==-1||player.rank.toLowerCase().indexOf(text)!==-1});this.openPage(0)};module.exports=PlayersList});require.register("players-list/template.js",function(exports,require,module){module.exports='<div class="players-list">\n    <div class="title">\n        <h1>meishengo</h1>\n    </div>\n    <div class="goban-bg"></div>\n    <div class="players-area players-area-top"></div>\n    <div class="players-area players-area-right"></div>\n    <div class="players-area players-area-bottom"></div>\n</div>'});require.register("player-menu/index.js",function(exports,require,module){var _=require("underscore"),$=require("jquery"),template=require("./template");function PlayerMenu(player){_.bindAll(this);this.player=player}PlayerMenu.prototype.render=function(){this.$el=$(template);$(".login",this.$el).html(this.player.login);return this};PlayerMenu.removeAll=function(){$(".player-menu").remove()};module.exports=PlayerMenu});require.register("player-menu/template.js",function(exports,require,module){module.exports='<div class="player-menu">\n    <div class="player">\n        <span class="login"></span>\n    </div>\n    <div class="actions">\n        <span class="action request" alt="Send a game request">request</span>\n    </div>\n</div>'});require.register("search/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),template=require("./template");function Search(options){_.bindAll(this);this.callback=options.change}Search.prototype.render=function(){this.$el=$(template);this.$text=$(".text",this.$el);this.$text.keyup(this.onTextChange);return this};Search.prototype.onTextChange=function(event){var text=$(".text",this.$el).val();if(text.length>1){this.callback(text)}};module.exports=Search});require.register("search/template.js",function(exports,require,module){module.exports='<div class="search">\n    <input type="text" class="text" placeholder="Search" />\n    <div class="button"></div>\n</div>'});require.register("players-page/index.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),TopMenu=require("top-menu"),PlayersList=require("players-list"),Footer=require("./footer"),Search=require("search"),PlayerTag=require("player-tag"),PlayerMenu=require("player-menu");function PlayersPage(){_.bindAll(this);this.pageIndex=0}PlayersPage.prototype.onListVisible=function(){$("footer").html(new Footer({next:this.onNext,previous:this.onPrevious}).render().$el);$("header").append(new Search({change:this.onSearchChange}).render().$el)};PlayersPage.prototype.open=function(){PlayerTag.onSelectPlayer(this.onSelectPlayer);$("header").html(new TopMenu("players").render().$el);this.playersList=new PlayersList({visible:this.onListVisible}).render();$("#content").html(this.playersList.$el)};PlayersPage.prototype.onNext=function(){var pageIndex=this.pageIndex+1;if(this.playersList.openPage(pageIndex)){this.pageIndex=pageIndex}};PlayersPage.prototype.onPrevious=function(){var pageIndex=this.pageIndex-1;if(this.playersList.openPage(pageIndex)){this.pageIndex=pageIndex}};PlayersPage.prototype.onSelectPlayer=function(player){PlayerMenu.removeAll();$("footer").append(new PlayerMenu(player).render().$el)};PlayersPage.prototype.onSearchChange=function(text){this.playersList.search(text)};module.exports=PlayersPage});require.register("players-page/footer.js",function(exports,require,module){"use strict";var _=require("underscore"),$=require("jquery"),template=require("./footer-template");function Footer(options){_.bindAll(this);this.onNext=options.next;this.onPrevious=options.previous}Footer.prototype.render=function(){this.$el=$(template);$(".next",this.$el).click(this.onNext);$(".previous",this.$el).click(this.onPrevious);return this};module.exports=Footer});require.register("players-page/footer-template.js",function(exports,require,module){module.exports='<div class="nav">\n    <div class="nav-button previous">\n        <span class="label">prev</span>\n    </div>\n\n    <div class="nav-button next">\n        <span class="label">next</span>\n    </div>\n</div>\n'});require.register("router/index.js",function(exports,require,module){"use strict";var _=require("underscore"),page=require("page"),LoginPage=require("login-page"),HomePage=require("home-page"),PlayersPage=require("players-page"),noop=function(){};function Router(){_.bindAll(this);page("#!/home",this.homePage);page("#!/players",this.playersPage);page("#!/games",noop);page("#!/profile",noop);page("*",this.loginPage)}Router.prototype.loginPage=function(){var loginPage=new LoginPage;loginPage.open()};Router.prototype.homePage=function(){var homePage=new HomePage;homePage.open()};Router.prototype.playersPage=function(){var playersPage=new PlayersPage;playersPage.open()};Router.prototype.start=function(){page();this.loginPage()};module.exports=Router});require.register("boot/index.js",function(exports,require,module){"use strict";var $=require("jquery"),Router=require("router");$(function(){var router=new Router;router.start()})});require.alias("boot/index.js","meishengo/deps/boot/index.js");require.alias("boot/index.js","boot/index.js");require.alias("component-jquery/index.js","boot/deps/jquery/index.js");require.alias("router/index.js","boot/deps/router/index.js");require.alias("component-underscore/index.js","router/deps/underscore/index.js");require.alias("visionmedia-page.js/index.js","router/deps/page/index.js");require.alias("login-page/index.js","router/deps/login-page/index.js");require.alias("login-page/footer-template.js","router/deps/login-page/footer-template.js");require.alias("login-page/content-template.js","router/deps/login-page/content-template.js");require.alias("component-jquery/index.js","login-page/deps/jquery/index.js");require.alias("component-underscore/index.js","login-page/deps/underscore/index.js");require.alias("visionmedia-page.js/index.js","login-page/deps/page/index.js");require.alias("dawicorti-Sonic/src/sonic.js","login-page/deps/Sonic/src/sonic.js");require.alias("dawicorti-Sonic/src/sonic.js","login-page/deps/Sonic/index.js");require.alias("dawicorti-Sonic/src/sonic.js","dawicorti-Sonic/index.js");require.alias("proxy-client/index.js","login-page/deps/proxy-client/index.js");require.alias("loader/index.js","login-page/deps/loader/index.js");require.alias("component-jquery/index.js","loader/deps/jquery/index.js");require.alias("component-underscore/index.js","loader/deps/underscore/index.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/src/sonic.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/index.js");require.alias("dawicorti-Sonic/src/sonic.js","dawicorti-Sonic/index.js");require.alias("login-form/index.js","login-page/deps/login-form/index.js");require.alias("login-form/template.js","login-page/deps/login-form/template.js");require.alias("component-jquery/index.js","login-form/deps/jquery/index.js");require.alias("component-underscore/index.js","login-form/deps/underscore/index.js");require.alias("visionmedia-page.js/index.js","login-form/deps/page/index.js");require.alias("loader/index.js","login-form/deps/loader/index.js");require.alias("component-jquery/index.js","loader/deps/jquery/index.js");require.alias("component-underscore/index.js","loader/deps/underscore/index.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/src/sonic.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/index.js");require.alias("dawicorti-Sonic/src/sonic.js","dawicorti-Sonic/index.js");require.alias("proxy-client/index.js","login-form/deps/proxy-client/index.js");require.alias("home-page/index.js","router/deps/home-page/index.js");require.alias("component-underscore/index.js","home-page/deps/underscore/index.js");require.alias("component-jquery/index.js","home-page/deps/jquery/index.js");require.alias("top-menu/index.js","home-page/deps/top-menu/index.js");require.alias("top-menu/template.js","home-page/deps/top-menu/template.js");require.alias("component-underscore/index.js","top-menu/deps/underscore/index.js");require.alias("component-jquery/index.js","top-menu/deps/jquery/index.js");require.alias("visionmedia-page.js/index.js","top-menu/deps/page/index.js");require.alias("players-page/index.js","router/deps/players-page/index.js");require.alias("players-page/footer.js","router/deps/players-page/footer.js");require.alias("players-page/footer-template.js","router/deps/players-page/footer-template.js");require.alias("component-jquery/index.js","players-page/deps/jquery/index.js");require.alias("component-underscore/index.js","players-page/deps/underscore/index.js");require.alias("visionmedia-page.js/index.js","players-page/deps/page/index.js");require.alias("top-menu/index.js","players-page/deps/top-menu/index.js");require.alias("top-menu/template.js","players-page/deps/top-menu/template.js");require.alias("component-underscore/index.js","top-menu/deps/underscore/index.js");require.alias("component-jquery/index.js","top-menu/deps/jquery/index.js");require.alias("visionmedia-page.js/index.js","top-menu/deps/page/index.js");require.alias("proxy-client/index.js","players-page/deps/proxy-client/index.js");require.alias("player-tag/index.js","players-page/deps/player-tag/index.js");require.alias("player-tag/template.js","players-page/deps/player-tag/template.js");require.alias("component-jquery/index.js","player-tag/deps/jquery/index.js");require.alias("component-underscore/index.js","player-tag/deps/underscore/index.js");require.alias("visionmedia-page.js/index.js","player-tag/deps/page/index.js");require.alias("players-list/index.js","players-page/deps/players-list/index.js");require.alias("players-list/template.js","players-page/deps/players-list/template.js");require.alias("component-jquery/index.js","players-list/deps/jquery/index.js");require.alias("component-underscore/index.js","players-list/deps/underscore/index.js");require.alias("loader/index.js","players-list/deps/loader/index.js");require.alias("component-jquery/index.js","loader/deps/jquery/index.js");require.alias("component-underscore/index.js","loader/deps/underscore/index.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/src/sonic.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/index.js");require.alias("dawicorti-Sonic/src/sonic.js","dawicorti-Sonic/index.js");require.alias("proxy-client/index.js","players-list/deps/proxy-client/index.js");require.alias("player-tag/index.js","players-list/deps/player-tag/index.js");require.alias("player-tag/template.js","players-list/deps/player-tag/template.js");require.alias("component-jquery/index.js","player-tag/deps/jquery/index.js");require.alias("component-underscore/index.js","player-tag/deps/underscore/index.js");require.alias("visionmedia-page.js/index.js","player-tag/deps/page/index.js");require.alias("player-menu/index.js","players-page/deps/player-menu/index.js");require.alias("player-menu/template.js","players-page/deps/player-menu/template.js");require.alias("component-jquery/index.js","player-menu/deps/jquery/index.js");require.alias("component-underscore/index.js","player-menu/deps/underscore/index.js");require.alias("loader/index.js","players-page/deps/loader/index.js");require.alias("component-jquery/index.js","loader/deps/jquery/index.js");require.alias("component-underscore/index.js","loader/deps/underscore/index.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/src/sonic.js");require.alias("dawicorti-Sonic/src/sonic.js","loader/deps/Sonic/index.js");require.alias("dawicorti-Sonic/src/sonic.js","dawicorti-Sonic/index.js");require.alias("search/index.js","players-page/deps/search/index.js");require.alias("search/template.js","players-page/deps/search/template.js");require.alias("component-jquery/index.js","search/deps/jquery/index.js");require.alias("component-underscore/index.js","search/deps/underscore/index.js");