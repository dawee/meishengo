...
window.boot = function (opts) {
  ...
  layout.echo(socket, 'game:joined', null, layout);
  layout.echo(socket, 'game:updated', null, layout);
  layout.echo(socket, 'greetings:request', null, layout);
  layout.echo(socket, 'greetings:refused', null, layout);
  layout.echo(socket, 'register:succeeded', null, layout);
  layout.echo(layout, 'game:create', null, socket);
  layout.echo(layout, 'game:join', null, socket);
  layout.echo(layout, 'game:spectate', null, socket);
  layout.echo(layout, 'game:stone:put', null, socket);
