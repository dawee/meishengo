...
game.ending = function () {
  ...
  this.countTerritories();
  this.el.classList.add('ending');
};

game.countTerritories = function () {
  var that = this;

  this.goban.countTerritories(function (territories, counters, prisoners) {
    that.gobanUX.showTerritories(territories);
    that.seats.black.setTerritories(counters.black);
    that.seats.black.setPrisoners(prisoners.white);
    that.seats.white.setTerritories(counters.white);
    that.seats.white.setPrisoners(prisoners.black);
  });  
}
