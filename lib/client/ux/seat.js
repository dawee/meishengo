...
ux.nextPassEndGame = function () {
  this.el.querySelector('.action.pass').firstChild.data = 'end game';
  this.isNextPassEnding = true;
};

ux.wontEndGame = function () {
  this.el.querySelector('.action.pass').firstChild.data = 'pass';
  this.isNextPassEnding = false;
};
