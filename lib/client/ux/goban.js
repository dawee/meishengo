...
var GobanUX = module.exports = function (goban) {
	_.bindAll(this, 'lock', 'unlock', 'showStone', 'hideStone', 'markStoneAsDead');
  ...
  this.goban.on('markup:dead', this.markStoneAsDead)
};
...
ux.markStoneAsDead = function (evt) {
  this.intersections[evt.row + ':' + evt.col].markStoneAsDead();
};
