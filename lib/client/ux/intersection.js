...
ux.click = function () {
  ...
  if (this.stone.classList.contains('put')) {
    this.emit('stone:markup:toggle', {row: this.row, col: this.col, markup: 'dead', ux: true});
  }
};

ux.markStoneAsDead = function () {
  this.stone.classList.add('dead');
};

ux.unmarkStoneAsDead = function () {
  this.stone.classList.remove('dead');
};
...
ux.setTerritory = function (color) {
  this.territory.classList.add('set');
  this.territory.classList.remove('black');
  this.territory.classList.remove('white');
  this.territory.classList.remove('dame');
  this.territory.classList.add(color);
};

ux.unsetTerritory = function () {
  this.territory.classList.remove('set');
  this.territory.classList.remove('black');
  this.territory.classList.remove('white');
  this.territory.classList.remove('dame');
};
...
ux.render = function () {
  ...
  this.territory = document.createElement('div');
  this.territory.classList.add('territory');
  this.el.appendChild(this.territory);
  return this;
}
