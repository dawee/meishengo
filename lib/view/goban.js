...
GobanView.prototype.initialize = function (opts) {
  ...
  this.$el
    ...
    .append($('<div>').addClass('mei-board-top-edge'))
    .append($('<div>').addClass('mei-board-right-edge'))
    .append($('<div>').addClass('mei-board-bottom-edge'))
    .append($('<div>').addClass('mei-board-left-edge'));
...
/* Handler for intersection click */
