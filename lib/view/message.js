...
Message.prototype.events = {
  ...
  'mousemove .pointer': 'pointIntersection'
}
...
Message.prototype.pointIntersection = function (evt) {
  var row = parseInt(evt.currentTarget.getAttribute('data-row'), 10);
  var col = parseInt(evt.currentTarget.getAttribute('data-col'), 10);
