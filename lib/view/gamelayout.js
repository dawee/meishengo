...
GameLayout.prototype.showNicknameForm = function () {
  this.sideForm.openWithNicknameForm();
  this.$sandwich.addClass('pushed');
};

GameLayout.prototype.showJoinForm = function () {
  this.sideForm.openWithJoinForm();
  this.$sandwich.addClass('pushed');
};
