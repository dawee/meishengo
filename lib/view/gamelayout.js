...
GameLayout.prototype.events = {
  ...
  'chat:message:system': 'openChatBox',
  'chatbox:focus': 'focusPrompt',
  'chatbox:unfocus': 'unfocusPrompt',
...
GameLayout.prototype.focusPrompt = function () {
  this.prompt.classList.add('focus');
};

GameLayout.prototype.unfocusPrompt = function () {
  this.prompt.classList.remove('focus');
};

GameLayout.prototype.openChatBox = function () {
...
GameLayout.prototype.openGame = function (data) {
  ...
  this.echo(this.content.chatbox, 'focus', 'chatbox:focus');
  this.echo(this.content.chatbox, 'unfocus', 'chatbox:unfocus');
};
