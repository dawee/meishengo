...
GameContentView.prototype.resize = function () {
  ...
  this.racks[playerColor].resize({top: 3, bottom: null, left: margin, width: dim, height: margin - 3});
  this.racks[opponentColor].resize({top: null, bottom: 3, left: margin, width: dim, height: margin - 3});
};
