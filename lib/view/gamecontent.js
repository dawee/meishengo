...
GameContentView.prototype.resize = function () {
  ...
  this.racks[opponentColor].resize({top: 3, left: margin, width: dim, height: margin - 3});
  this.racks[playerColor].resize({bottom: 3, left: margin, width: dim, height: margin - 3});
};
