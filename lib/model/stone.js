...
Stone.prototype.liberties = function (stones, gsize) {
  ...
  var liberties = new Stone.Collection(_.values(slots));

  if (this.get('row') === 0 || stones.has(slots.top)) liberties.remove(slots.top);
  if (this.get('col') === gsize - 1 || stones.has(slots.right)) liberties.remove(slots.right);
  if (this.get('row') === gsize - 1 || stones.has(slots.bottom)) liberties.remove(slots.bottom);
  if (this.get('col') === 0 || stones.has(slots.left)) liberties.remove(slots.left);
