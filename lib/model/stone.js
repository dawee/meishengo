...
Stone.prototype.liberties = function (stones, gsize) {
  ...
  if (this.get('row') === 0 || stones.has(slots.top)) delete slots.top;
  if (this.get('col') === gsize - 1 || stones.has(slots.right)) delete slots.right;
  if (this.get('row') === gsize - 1 || stones.has(slots.bottom)) delete slots.bottom;
  if (this.get('col') === 0 || stones.has(slots.left)) delete slots.left;
